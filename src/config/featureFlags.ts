...
type FeatureFlagKey = 'NEW_IA_NAV_AND_HOME' | 'AI_ASSIST' | 'DPP_INTEGRATION' | 'MAP_VIEW';

interface FeatureFlags {
  NEW_IA_NAV_AND_HOME: boolean;
  AI_ASSIST: boolean;
  DPP_INTEGRATION: boolean;
  MAP_VIEW: boolean;
}
...
export function getFlags(): FeatureFlags {
  return {
    ...
    AI_ASSIST: isFeatureEnabled('AI_ASSIST'),
    DPP_INTEGRATION: isFeatureEnabled('DPP_INTEGRATION'),
    MAP_VIEW: isFeatureEnabled('MAP_VIEW'),
  };
}
...
export const flags = {
  ...
  get AI_ASSIST() {
    return isFeatureEnabled('AI_ASSIST');
  },
  get DPP_INTEGRATION() {
    return isFeatureEnabled('DPP_INTEGRATION');
  },
  get MAP_VIEW() {
    return isFeatureEnabled('MAP_VIEW');
  },
};
