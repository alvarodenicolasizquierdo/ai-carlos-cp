...
import { CarlosLauncher } from "@/components/carlos/CarlosLauncher";
...
// Eagerly load the dashboard (initial route)
        ...
        <DraftsProvider>
          <TooltipProvider>
            ...
            <BrowserRouter>
              ...
              <HelpDrawer />
              {/* Global Ask Carlos floating chat - Intercom Messenger pattern */}
              <CarlosLauncher />
