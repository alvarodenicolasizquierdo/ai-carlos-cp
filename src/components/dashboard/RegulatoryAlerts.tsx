...
const alerts: RegulatoryAlert[] = [
  ...
  },
  {
    ...
    message: 'Updated warning label requirements for products sold in California. Estimated effective: Q3 2026 (as announced).',
    type: 'info',
    date: '2026-01-28'
  }
];
    ...
    <div className="space-y-1.5 md:space-y-2">
      {visibleAlerts.map((alert) => (
        <div
          key={alert.id}
          className={cn(
            "p-2 md:p-3 rounded-lg flex items-start gap-2 md:gap-3 animate-fade-in",
      ...
      {/* FIX 6: Disclaimer for regulatory dates */}
      <p className="text-[10px] text-muted-foreground px-2 pt-1">
        Dates reflect publicly announced regulatory timelines. Not an AI prediction.
      </p>
    </div>
  );
}
