...
export function Sidebar() {
  ...
  return (
    <aside
      ...
      className="fixed left-0 top-0 h-screen bg-sidebar flex-col z-50 hidden md:flex transition-[width] duration-200 ease-in-out"
    >
      {/* Logo Section */}
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {!isCollapsed && (
                      <span className="flex-1 whitespace-nowrap transition-opacity duration-200">
                        {item.label}
                      </span>
                    )}
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="w-full">
            <div className={cn(
              ...
              {!isCollapsed && (
                <div className="flex-1 text-left overflow-hidden transition-opacity duration-200">
