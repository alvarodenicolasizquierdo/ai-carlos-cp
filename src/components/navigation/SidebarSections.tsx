...
function filterGroupForDemo(group: NavGroup): NavGroup {
  return {
    ...group,
...
export function SidebarSections({ isCollapsed, isAdmin }: SidebarSectionsProps) {
  ...
  // In demo mode, hide governance/admin sections entirely
  ...
  return (
    <div className="space-y-2">
      ...
      <SidebarSection 
        title="Products" 
        group={isDemoMode ? filterGroupForDemo(productsGroup) : productsGroup}
        isCollapsed={isCollapsed}
        isAdmin={isAdmin}
      />
      ...
      <SidebarSection 
        title="Testing" 
        group={isDemoMode ? filterGroupForDemo(testingGroup) : testingGroup}
        isCollapsed={isCollapsed}
        isAdmin={isAdmin}
      />
      ...
      <SidebarSection 
        title="Insights" 
        group={isDemoMode ? filterGroupForDemo(insightsGroup) : insightsGroup}
        isCollapsed={isCollapsed}
        isAdmin={isAdmin}
      />
