...
import { AppMapTab, RolesTab, WorkflowsTab, DataModelTab, ExportTab, FeatureFlagsTab } from '@/components/documentation';
import { Map, Users, GitBranch, Database, Download, ToggleRight } from 'lucide-react';
        ...
        <Tabs defaultValue="app-map" className="space-y-6">
          <TabsList className="grid w-full grid-cols-6 lg:w-auto lg:inline-grid">
            ...
            <TabsTrigger value="flags" className="gap-2">
              <ToggleRight className="h-4 w-4 hidden sm:block" />
              Flags
            </TabsTrigger>
          </TabsList>
