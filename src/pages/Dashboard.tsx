...
import { Year1ModeBanner } from '@/components/compliance/Year1ModeBanner';
...
export default function Dashboard() {
  useEffect(() => { tagScreen('ai-dashboard'); }, []);
    ...
    return (
      <AppLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
          <div className="w-12 h-12 rounded-full bg-gradient-to-r from-ai-primary to-ai-secondary flex items-center justify-center animate-spin" style={{ animationDuration: '2s' }}>
    ...
    <AppLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="lg:col-span-2 space-y-4 md:space-y-6">
          ...
          {(showTasksWidget || (!isSupplier && layoutConfig.primaryWidget !== 'tasks')) && (
            <Card className="border-2 border-ai-primary/20" data-tour="tasks-widget">
              <CardHeader className="pb-3">
                ...
                {/* FIX 2: AI Disclaimer inside task widget */}
                <AIDisclaimerBanner className="mt-3" />
              </CardHeader>
          ...
          {/* Scenario Simulator - hide for suppliers, internal only in demo mode */}
          {!isSupplier && (
            <InternalOnly>
